...
<div class="ec-content-wrapper">
				<div class="content">
					<div class="breadcrumb-wrapper breadcrumb-contacts">
						<div>
							<h1>Offer Zone Products</h1>
							<p class="breadcrumbs"><span><a href="">Offerzone</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>Products
							</p>
						</div>
						<div>
                            <a href="<?php echo base_url();?>Admin/add_offer_products">
	...
	<!-- Add Contact Button  -->
				...
				<!-- End Content -->
				 ...
				 <!-- deactive banner  -->
                            ...
                            <form method="post" id="deleteForm" action="<?php echo base_url(); ?>Admin/checkbannerActive">
                                 <div class="icon-box">
...
<div class="modal fade zoomIn" id="deleteRecordModal" tabindex="-1" aria-labelledby="deleteRecordLabel" aria-hidden="true">
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body p-5 text-center">
                            <form method="post" id="deleteForm" action="<?php echo base_url(); ?>Admin/deleteOfferProduct">
         <!--<div class="icon-box">-->
				<i class="fa-solid fa-trash" style="font-weight: 1000;height: -30px;font-size: 58px;color: #ec4a58;}"></i>
				<!--</div>	-->
          <div class="mt-4 text-center">
              <input type="hidden"  name="offer_product_id" id="offerID">
            <h4 class="fs-semibold">You are about to delete a Offer product?</h4>
