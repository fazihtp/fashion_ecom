				...
				<div class="breadcrumb-wrapper breadcrumb-contacts">
						<div>
							...
							<p class="breadcrumbs"><span><a href="">Orders</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>Processing Orders
							</p>
						</div>
						<div>
         ...
         <!--<div class="icon-box">-->
          ...
          <div class="mt-4 text-center">
            ...
            <div class="hstack gap-2 justify-content-center remove">
                <input type="hidden" id="delete_order_id" name="deleteorder">
                      ...
                      <div class="modal-body p-5 text-center">
                		...
                		<i class="fa fa-check" style="font-weight: 1000;height: -30px;font-size: 58px;color: #32CD32;}"></i>
                          ...
                          <div class="mt-4 text-center">
                            ...
                            <h4 class="fs-semibold">Are you sure about Deliver to the Order?</h4>
