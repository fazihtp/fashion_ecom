										...
										<table id="customerTable" class="table">
                                            ...
                                            <tfoot>
                                                <tr>
												    ...
												    <th></th>
													<th></th>
													<th class="totalShipping" style="width:28px"></th>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body p-5 text-center">
              ...
              <button type="submit" class="btn btn-danger" id="delete-record" >Yes, Delete It!!</button>
				...
				<div class="modal fade modal-add-contact" id="approvedModal" tabindex="-1" role="dialog" aria-hidden="true" >
                     ...
                     <div class="modal-content" style="width: 507px;    margin-left: 132px;">
                      ...
                      <div class="modal-body p-5 text-center">
                        <form method="post" action="<?php echo base_url(); ?>Orders/ChangeToProcessed" >
                         <!--<div class="icon-box">-->
                		<i class="fa fa-check" style="font-weight: 1000;height: -30px;font-size: 58px;color: #32CD32;}"></i>
                				<!--</div>	-->
                          <div class="mt-4 text-center">
                              <input type="hidden" name="order_id" id="order_id" >
                            <h4 class="fs-semibold">Are you sure to Process Order?</h4>
		...
		<div class="modal fade modal-add-contact" id="refundModal" tabindex="-1" role="dialog" aria-hidden="true" >
                      <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                     <div class="modal-content" style="width: 507px;    margin-left: 132px;">
                      <div class="modal-header">
                        <button type="button" class="btn-close" id="deleteRecord-close" data-bs-dismiss="modal" aria-label="Close" fdprocessedid="v0hp98">
                      ...
                      <div class="modal-body p-5 text-center">
                        <form method="post" action="<?php echo base_url(); ?>Orders/ChangeToNewOrder" >
                         <!--<div class="icon-box">-->
                         
                         <span class='mdi mdi-cash-refund' style='font-size:82px;'></span>
                		<!--<i class="fa fa-check" style="font-weight: 1000;height: -30px;font-size: 58px;color: #32CD32;}"></i>-->
                				<!--</div>	-->
                          <div class="mt-4 text-center">
                              <input type="hidden" name="refund_order_id" id="refund_order_id" >
                            <h4 class="fs-semibold">Are you sure to Refund Order?</h4>
                            <p class="text-muted fs-14 mb-4 pt-1"></p>
                            <div class="hstack gap-2 justify-content-center remove">
                              <button type="button" class="btn btn-link link-success fw-medium text-decoration-none" data-bs-dismiss="modal" fdprocessedid="2mc1b"> <i class="ri-close-line me-1 align-middle"></i> Close </button>
                              <button type="submit" class="btn btn-success" id="delete-record" fdprocessedid="tib7hj" >Yes, Refund it!</button>
                            </div>
                          </div>
                        </form>
                      </div>
...
$(document).ready(function() {
    $('#customerTable').DataTable({
        ...
        'scrollY': '100%',
        'ajax': {
            'url': '<?=base_url()?>Orders/getAllOrderList',
            'type': 'POST',
            'data': function(d) {
            // alert(d)
            ...
            if (json_response.recordsTotal) {
                $(".totalShipping").html('<font size="3px;" color="#FF0000"><strong> '+json_response.totalShipping+'</strong></font>');
                $(".totalProducts").html('<font size="3px;" color="#FF0000"><strong> '+json_response.totalProducts+'</strong></font>');
                $(".totalAmount").html('<font size="3px;" color="#FF0000"><strong> '+json_response.totalAmount+'</strong></font>');
            }
            return response;
        }, 
        },
...
function takeValues() {
    ...
    if (selectedValues.length === 0) {
        ...
        $.ajax({
           'url': '<?=base_url()?>Orders/getUpdates',
            type: 'POST',
            data: { selectedValues: selectedValues,
                    setings_id:settings_id},
