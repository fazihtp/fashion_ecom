					...
					<div class="breadcrumb-wrapper breadcrumb-contacts">
						<div>
							...
							<p class="breadcrumbs"><span><a href="#">List</a></span>
								<span><i class="mdi mdi-chevron-right"></i></span>Shipped Orders
							</p>
						</div>
						<div>
						    	</div>
                      ...
                      <div class="modal-body p-5 text-center">
                		...
                		<i class="fa fa-check" style="font-weight: 1000;height: -30px;font-size: 58px;color: #32CD32;}"></i>
                          ...
                          <div class="mt-4 text-center">
                            ...
                            <h4 class="fs-semibold">Are you Sure to  Update Trackind ID?</h4>
                            ...
                            <div class="hstack gap-2 justify-content-center remove">
                              ...
                              <button type="submit" class="btn btn-success" id="delete-record" fdprocessedid="tib7hj" >Yes, Update it!</button>
                            </div>
                          </div>
                        </form>
                      </div>
...
$(document).ready(function() {
    $('#customerTable').DataTable({
        ...
        'scrollY': '100%',
        'ajax': {
            'url': '<?=base_url()?>Orders/getShippedOrders',
            'type': 'POST',
            'data': function(d) {
...
function change_status(id,tracking_id){
    $('#order_id').val(id);
