...
// if (doughnut !== null) {
//     // Fetch order counts from the server
//     fetch('Dashboard/get_order_counts')  // Update the URL
//         .then(response => response.json())
//         .then(orderCounts => {
//             var myDoughnutChart = new Chart(doughnut, {
//                 type: "doughnut",
//                 data: {
//                     labels: ["new_orders", "Processing", "Shipping"],
//                     datasets: [
//                         {
//                             data: [orderCounts.PENDING, orderCounts.Processing, orderCounts.Shipping],
  ...
  if (doughnut !== null) {
    var myDoughnutChart = new Chart(doughnut, {
      ...
      data: {
        ...
        datasets: [
          {
            label: ["new_orders", "Processing", "Shipping"],
            data: [4100, 2500, 1800],
            backgroundColor: ["#88aaf3", "#50d7ab", "#9586cd"],
            borderWidth: 1
